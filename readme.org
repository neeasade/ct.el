...
Supported color spaces: [[#rgb][rgb]] • [[#hsl][hsl]] • [[#hsv][hsv]] • [[#hsluv][hsluv]] • [[#hpluv][hpluv]] • [[#cielab][(cie)lab]] • [[#cielch][(cie)lch]] • [[#okLAB][(ok)lab]]• [[#okLCH][(ok)lch]]• [[#hct][hct]]
...
*** okLCH
- [[#ct-make-oklch-lightness-chroma-hue][ct-make-oklch]] ~(lightness chroma hue)~
- [[#ct-get-oklch-color][ct-get-oklch]] ~(color)~
- [[#ct-get-oklch-l-color][ct-get-oklch-l]] ~(color)~
- [[#ct-get-oklch-c-color][ct-get-oklch-c]] ~(color)~
- [[#ct-get-oklch-h-color][ct-get-oklch-h]] ~(color)~
- [[#ct-edit-oklch-color-edit-fn][ct-edit-oklch]] ~(color edit-fn)~
- [[#ct-edit-oklch-l-color-func-or-val][ct-edit-oklch-l]] ~(color func-or-val)~
- [[#ct-edit-oklch-l-dec-color-optional-amount][ct-edit-oklch-l-dec]] ~(color &optional amount)~
- [[#ct-edit-oklch-l-inc-color-optional-amount][ct-edit-oklch-l-inc]] ~(color &optional amount)~
- [[#ct-edit-oklch-h-color-func-or-val][ct-edit-oklch-h]] ~(color func-or-val)~
- [[#ct-edit-oklch-h-dec-color-optional-amount][ct-edit-oklch-h-dec]] ~(color &optional amount)~
- [[#ct-edit-oklch-h-inc-color-optional-amount][ct-edit-oklch-h-inc]] ~(color &optional amount)~
- [[#ct-edit-oklch-c-color-func-or-val][ct-edit-oklch-c]] ~(color func-or-val)~
- [[#ct-edit-oklch-c-dec-color-optional-amount][ct-edit-oklch-c-dec]] ~(color &optional amount)~
- [[#ct-edit-oklch-c-inc-color-optional-amount][ct-edit-oklch-c-inc]] ~(color &optional amount)~
*** hct
- [[#ct-make-hct-hue-chroma-tone][ct-make-hct]] ~(hue chroma tone)~
- [[#ct-get-hct-color][ct-get-hct]] ~(color)~
- [[#ct-get-hct-h-color][ct-get-hct-h]] ~(color)~
- [[#ct-get-hct-c-color][ct-get-hct-c]] ~(color)~
- [[#ct-get-hct-t-color][ct-get-hct-t]] ~(color)~
- [[#ct-edit-hct-color-edit-fn][ct-edit-hct]] ~(color edit-fn)~
- [[#ct-edit-hct-c-color-func-or-val][ct-edit-hct-c]] ~(color func-or-val)~
- [[#ct-edit-hct-c-dec-color-optional-amount][ct-edit-hct-c-dec]] ~(color &optional amount)~
- [[#ct-edit-hct-c-inc-color-optional-amount][ct-edit-hct-c-inc]] ~(color &optional amount)~
- [[#ct-edit-hct-h-color-func-or-val][ct-edit-hct-h]] ~(color func-or-val)~
- [[#ct-edit-hct-h-dec-color-optional-amount][ct-edit-hct-h-dec]] ~(color &optional amount)~
- [[#ct-edit-hct-h-inc-color-optional-amount][ct-edit-hct-h-inc]] ~(color &optional amount)~
- [[#ct-edit-hct-t-color-func-or-val][ct-edit-hct-t]] ~(color func-or-val)~
- [[#ct-edit-hct-t-dec-color-optional-amount][ct-edit-hct-t-dec]] ~(color &optional amount)~
- [[#ct-edit-hct-t-inc-color-optional-amount][ct-edit-hct-t-inc]] ~(color &optional amount)~
** Color Properties
...
**** ct-complement ~(color)~
Get the complement of a color in the hsluv space
#+BEGIN_src elisp
...
Decrease rgb-b property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Increase rgb-b property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease rgb-g property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Increase rgb-g property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease rgb-r property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Increase rgb-r property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease lab-a property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Increase lab-a property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease lab-b property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Increase lab-b property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease lab-l property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-lab-l-dec "#4fa5e8") ;; => "#4ea4e7"
#+END_src
**** ct-edit-lab-l-inc ~(color &optional amount)~
Increase lab-l property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hsl-h property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hsl-h-dec "#4fa5e8") ;; => "#4fa6e8"
#+END_src
**** ct-edit-hsl-h-inc ~(color &optional amount)~
Increase hsl-h property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hsl-l property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hsl-l-dec "#4fa5e8") ;; => "#4ea4e7"
#+END_src
**** ct-edit-hsl-l-inc ~(color &optional amount)~
Increase hsl-l property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hsl-s property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hsl-s-dec "#4fa5e8") ;; => "#4fa4e7"
#+END_src
**** ct-edit-hsl-s-inc ~(color &optional amount)~
Increase hsl-s property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hsluv-h property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hsluv-h-dec "#4fa5e8") ;; => "#4ea5e7"
#+END_src
**** ct-edit-hsluv-h-inc ~(color &optional amount)~
Increase hsluv-h property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hsluv-l property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hsluv-l-dec "#4fa5e8") ;; => "#4ea4e7"
#+END_src
**** ct-edit-hsluv-l-inc ~(color &optional amount)~
Increase hsluv-l property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hsluv-s property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hsluv-s-dec "#4fa5e8") ;; => "#4fa4e7"
#+END_src
**** ct-edit-hsluv-s-inc ~(color &optional amount)~
Increase hsluv-s property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease lch-c property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-lch-c-dec "#4fa5e8") ;; => "#4fa4e7"
#+END_src
**** ct-edit-lch-c-inc ~(color &optional amount)~
Increase lch-c property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease lch-h property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-lch-h-dec "#4fa5e8") ;; => "#4ea5e7"
#+END_src
**** ct-edit-lch-h-inc ~(color &optional amount)~
Increase lch-h property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease lch-l property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-lch-l-dec "#4fa5e8") ;; => "#4ea4e7"
#+END_src
**** ct-edit-lch-l-inc ~(color &optional amount)~
Increase lch-l property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hsv-h property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hsv-h-dec "#4fa5e8") ;; => "#4ea5e8"
#+END_src
**** ct-edit-hsv-h-inc ~(color &optional amount)~
Increase hsv-h property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hsv-s property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hsv-s-dec "#4fa5e8") ;; => "#50a5e8"
#+END_src
**** ct-edit-hsv-s-inc ~(color &optional amount)~
Increase hsv-s property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hsv-v property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hsv-v-dec "#4fa5e8") ;; => "#4ea4e7"
#+END_src
**** ct-edit-hsv-v-inc ~(color &optional amount)~
Increase hsv-v property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hpluv-h property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hpluv-h-dec "#4fa5e8") ;; => "#71a2d2"
#+END_src
**** ct-edit-hpluv-h-inc ~(color &optional amount)~
Increase hpluv-h property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hpluv-l property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hpluv-l-dec "#4fa5e8") ;; => "#71a2d2"
#+END_src
**** ct-edit-hpluv-l-inc ~(color &optional amount)~
Increase hpluv-l property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease hpluv-p property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hpluv-p-dec "#4fa5e8") ;; => "#72a2d2"
#+END_src
**** ct-edit-hpluv-p-inc ~(color &optional amount)~
Increase hpluv-p property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease oklab-l property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-oklab-l-dec "#4fa5e8") ;; => "#4ea4e7"
#+END_src
**** ct-edit-oklab-l-inc ~(color &optional amount)~
Increase oklab-l property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease oklab-a property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-oklab-a-dec "#4fa5e8") ;; => "#4da5e8"
#+END_src
**** ct-edit-oklab-a-inc ~(color &optional amount)~
Increase oklab-a property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
Decrease oklab-b property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-oklab-b-dec "#4fa5e8") ;; => "#4ea4e8"
#+END_src
**** ct-edit-oklab-b-inc ~(color &optional amount)~
Increase oklab-b property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
...
** okLCH
https://bottosson.github.io/posts/oklab/
**** ct-make-oklch ~(lightness chroma hue)~
Make a oklch color using properties: LIGHTNESS, CHROMA, HUE.
#+BEGIN_src elisp
(ct-make-oklch 70 13 245) ;; => "#4fa5e9"
#+END_src
#+BEGIN_quote
 → [[http://muffin.app.neeasade.net/colorsquare/4fa5e9.svg]]
#+END_quote
**** ct-get-oklch ~(color)~
Get oklch representation (Lightness, Chroma, Hue) of COLOR.
#+BEGIN_src elisp
(ct-get-oklch "#4fa5e8") ;; => (70 13 245)
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → (70 13 245)
#+END_quote
**** ct-get-oklch-l ~(color)~
Get oklch Lightness value of COLOR.
#+BEGIN_src elisp
(ct-get-oklch-l "#4fa5e8") ;; => 70
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → 70
#+END_quote
**** ct-get-oklch-c ~(color)~
Get oklch Chroma value of COLOR.
#+BEGIN_src elisp
(ct-get-oklch-c "#4fa5e8") ;; => 13
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → 13
#+END_quote
**** ct-get-oklch-h ~(color)~
Get oklch Hue value of COLOR.
#+BEGIN_src elisp
(ct-get-oklch-h "#4fa5e8") ;; => 245
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → 245
#+END_quote
**** ct-edit-oklch ~(color edit-fn)~
...
#+BEGIN_src elisp
(ct-edit-oklch "#4fa5e8" (lambda (L C H) (list L 100 H))) ;; => "#3e00ff"
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → [[http://muffin.app.neeasade.net/colorsquare/3e00ff.svg]]
#+END_quote
**** ct-edit-oklch-l ~(color func-or-val)~
Transform oklch Lightness of COLOR using FUNC-OR-VAL.
#+BEGIN_src elisp
(ct-edit-oklch-l "#4fa5e8" 30) ;; => "#002e68"
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → [[http://muffin.app.neeasade.net/colorsquare/002e68.svg]]
#+END_quote
**** ct-edit-oklch-l-dec ~(color &optional amount)~
Decrease oklch-l property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-oklch-l-dec "#4fa5e8") ;; => "#4ea4e7"
#+END_src
**** ct-edit-oklch-l-inc ~(color &optional amount)~
Increase oklch-l property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-oklch-l-inc "#4fa5e8") ;; => "#4fa5e9"
#+END_src
**** ct-edit-oklch-h ~(color func-or-val)~
Transform oklch Hue of COLOR using FUNC-OR-VAL.
#+BEGIN_src elisp
(ct-edit-oklch-h "#4fa5e8" 0) ;; => "#dd799a"
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → [[http://muffin.app.neeasade.net/colorsquare/dd799a.svg]]
#+END_quote
**** ct-edit-oklch-h-dec ~(color &optional amount)~
Decrease oklch-h property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-oklch-h-dec "#4fa5e8") ;; => "#4ea5e7"
#+END_src
**** ct-edit-oklch-h-inc ~(color &optional amount)~
Increase oklch-h property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-oklch-h-inc "#4fa5e8") ;; => "#4fa4e8"
#+END_src
**** ct-edit-oklch-c ~(color func-or-val)~
Transform oklch Chroma of COLOR using FUNC-OR-VAL.
#+BEGIN_src elisp
(ct-edit-oklch-c "#4fa5e8" 100) ;; => "#3e00ff"
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → [[http://muffin.app.neeasade.net/colorsquare/3e00ff.svg]]
#+END_quote
**** ct-edit-oklch-c-dec ~(color &optional amount)~
Decrease oklch-c property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-oklch-c-dec "#4fa5e8") ;; => "#4fa4e7"
#+END_src
**** ct-edit-oklch-c-inc ~(color &optional amount)~
Increase oklch-c property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-oklch-c-inc "#4fa5e8") ;; => "#4ea5e8"
#+END_src
** hct
https://m3.material.io/blog/science-of-color-design
**** ct-make-hct ~(hue chroma tone)~
Make a hct color using properties: HUE, CHROMA, TONE.
#+BEGIN_src elisp
(ct-make-hct 70 13 245) ;; => "#ffffff"
#+END_src
#+BEGIN_quote
 → [[http://muffin.app.neeasade.net/colorsquare/ffffff.svg]]
#+END_quote
**** ct-get-hct ~(color)~
Get hct representation (Hue, Chroma, Tone) of COLOR.
#+BEGIN_src elisp
(ct-get-hct "#4fa5e8") ;; => (247 50 65)
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → (247 50 65)
#+END_quote
**** ct-get-hct-h ~(color)~
Get hct Hue value of COLOR.
#+BEGIN_src elisp
(ct-get-hct-h "#4fa5e8") ;; => 247
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → 247
#+END_quote
**** ct-get-hct-c ~(color)~
Get hct Chroma value of COLOR.
#+BEGIN_src elisp
(ct-get-hct-c "#4fa5e8") ;; => 50
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → 50
#+END_quote
**** ct-get-hct-t ~(color)~
Get hct Tone value of COLOR.
#+BEGIN_src elisp
(ct-get-hct-t "#4fa5e8") ;; => 65
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → 65
#+END_quote
**** ct-edit-hct ~(color edit-fn)~
...
#+BEGIN_src elisp
(ct-edit-hct "#4fa5e8" (lambda (L C H) (list L 100 H))) ;; => "#00a6fd"
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → [[http://muffin.app.neeasade.net/colorsquare/00a6fd.svg]]
#+END_quote
**** ct-edit-hct-c ~(color func-or-val)~
Transform hct Chroma of COLOR using FUNC-OR-VAL.
#+BEGIN_src elisp
(ct-edit-hct-c "#4fa5e8" 100) ;; => "#00a6fd"
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → [[http://muffin.app.neeasade.net/colorsquare/00a6fd.svg]]
#+END_quote
**** ct-edit-hct-c-dec ~(color &optional amount)~
Decrease hct-c property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hct-c-dec "#4fa5e8") ;; => "#50a5e8"
#+END_src
**** ct-edit-hct-c-inc ~(color &optional amount)~
Increase hct-c property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hct-c-inc "#4fa5e8") ;; => "#4ea5e8"
#+END_src
**** ct-edit-hct-h ~(color func-or-val)~
Transform hct Hue of COLOR using FUNC-OR-VAL.
#+BEGIN_src elisp
(ct-edit-hct-h "#4fa5e8" 0) ;; => "#e87da1"
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → [[http://muffin.app.neeasade.net/colorsquare/e87da1.svg]]
#+END_quote
**** ct-edit-hct-h-dec ~(color &optional amount)~
Decrease hct-h property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hct-h-dec "#4fa5e8") ;; => "#4ea5e8"
#+END_src
**** ct-edit-hct-h-inc ~(color &optional amount)~
Increase hct-h property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hct-h-inc "#4fa5e8") ;; => "#50a5e8"
#+END_src
**** ct-edit-hct-t ~(color func-or-val)~
Transform hct Tone of COLOR using FUNC-OR-VAL.
#+BEGIN_src elisp
(ct-edit-hct-t "#4fa5e8" 30) ;; => "#004a75"
#+END_src
#+BEGIN_quote
[[http://muffin.app.neeasade.net/colorsquare/4fa5e8.svg]] → [[http://muffin.app.neeasade.net/colorsquare/004a75.svg]]
#+END_quote
**** ct-edit-hct-t-dec ~(color &optional amount)~
Decrease hct-t property of COLOR by AMOUNT.
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hct-t-dec "#4fa5e8") ;; => "#4ea4e7"
#+END_src
**** ct-edit-hct-t-inc ~(color &optional amount)~
Increase hct-t property of COLOR by AMOUNT
If AMOUNT is nil, defaults to minimum value needed to change color.
#+BEGIN_src elisp
(ct-edit-hct-t-inc "#4fa5e8") ;; => "#50a6e9"
#+END_src
