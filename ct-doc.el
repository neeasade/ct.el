  ...
  (let* ((ct-funcs (ct--get-functions))
    ...
    (setq ct--docs
      `(
         ...
         ((ct-make-oklch ,@(ct-get-oklch color))
           (ct-get-oklch ,color)
           (ct-get-oklch-l ,color)
           (ct-get-oklch-c ,color)
           (ct-get-oklch-h ,color)
           (ct-edit-oklch ,color (lambda (L C H) (list L 100 H)))
           (ct-edit-oklch-l ,color 30)
           (ct-edit-oklch-l-dec ,color)
           (ct-edit-oklch-l-inc ,color)
           (ct-edit-oklch-h ,color 0)
           (ct-edit-oklch-h-dec ,color)
           (ct-edit-oklch-h-inc ,color)
           (ct-edit-oklch-c ,color 100)
           (ct-edit-oklch-c-dec ,color)
         ...
         ((ct-make-hct ,@(ct-get-oklch color))
           ...
           (ct-get-hct-c ,color)
           (ct-get-hct-t ,color)
           (ct-edit-hct ,color (lambda (L C H) (list L 100 H)))
           (ct-edit-hct-c ,color 100)
           (ct-edit-hct-c-dec ,color)
           (ct-edit-hct-c-inc ,color)
           (ct-edit-hct-h ,color 0)
           (ct-edit-hct-h-dec ,color)
           (ct-edit-hct-h-inc ,color)
           (ct-edit-hct-t ,color 30)
           (ct-edit-hct-t-dec ,color)
           (ct-edit-hct-t-inc ,color))
         )))
